...
const Footer = () => {
    ...
    return(
        ...
        <div className="flex flex-row">
                      <div className="flex flex-row relattive border border-solid border-white rounded-[16px] h-[40px] text-white ml-[16px] cursor-pointer items-center font-[600] text-[14px] pr-[16px] pl-[16px] mt-[8px]">
